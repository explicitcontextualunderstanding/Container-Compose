...
- ✅ `registry.rossollc.com/walg-db:vsock` - OK
- ✅ `registry.rossollc.com/hermes:latest` - OK
- ✅ `registry.rossollc.com/codegraph-mcp:latest` - OK
...
3. **Private registry access**:
   - Ensure Jetson devices can pull from registry.rossollc.com
